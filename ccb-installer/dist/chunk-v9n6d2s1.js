...
async function createBridgeSession({
  ...
  const { getClaudeAIOAuthTokens } = await import("./chunk-cf43pt17.js");
  const { getOrganizationUUID } = await import("./chunk-ewbfkeeh.js");
  const { getOauthConfig } = await import("./chunk-p1yvkaqh.js");
  const { getOAuthHeaders } = await import("./chunk-04s2ykc2.js");
  const { parseGitHubRepository } = await import("./chunk-efkjha6m.js");
  const { getDefaultBranch } = await import("./chunk-5zbp0a48.js");
  const { getMainLoopModel } = await import("./chunk-05jay43a.js");
  const { default: axios } = await import("./chunk-r41sjxcn.js");
  const { isSelfHostedBridge } = await import("./chunk-4e3981ad.js");
  ...
  let gitOutcome = null;
  if (gitRepoUrl) {
    const { parseGitRemote } = await import("./chunk-efkjha6m.js");
