...
// node_modules/.bun/@aws-sdk+credential-provider-node@3.972.30/node_modules/@aws-sdk/credential-provider-node/dist-es/remoteProvider.js
var import_property_provider, ENV_IMDS_DISABLED = "AWS_EC2_METADATA_DISABLED", remoteProvider = async (init) => {
  const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("./chunk-gjfa8v40.js");
...
// node_modules/.bun/@aws-sdk+credential-provider-node@3.972.30/node_modules/@aws-sdk/credential-provider-node/dist-es/runtime/memoize-chain.js
...
// node_modules/.bun/@aws-sdk+credential-provider-node@3.972.30/node_modules/@aws-sdk/credential-provider-node/dist-es/defaultProvider.js
...
`);
  ...
  async (awsIdentityProperties) => {
    ...
    const { fromIni } = await import("./chunk-vxywgzw9.js");
    return fromIni(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
    const { fromProcess } = await import("./chunk-fhfp2q8c.js");
    return fromProcess(init)(awsIdentityProperties);
  },
  async (awsIdentityProperties) => {
    init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
    const { fromTokenFile } = await import("./chunk-sc90mcbc.js");
...
// node_modules/.bun/@aws-sdk+credential-provider-node@3.972.30/node_modules/@aws-sdk/credential-provider-node/dist-es/index.js
