...
// node_modules/.bun/@aws-sdk+credential-provider-web-identity@3.972.29/node_modules/@aws-sdk/credential-provider-web-identity/dist-es/fromWebToken.js
var fromWebToken = (init) => async (awsIdentityProperties) => {
  init.logger?.debug("@aws-sdk/credential-provider-web-identity - fromWebToken");
  const { roleArn, roleSessionName, webIdentityToken, providerId, policyArns, policy, durationSeconds } = init;
  let { roleAssumerWithWebIdentity } = init;
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./chunk-6yc3628e.js").then((m)=>__toESM(m.default,1));
...
// node_modules/.bun/@aws-sdk+credential-provider-web-identity@3.972.29/node_modules/@aws-sdk/credential-provider-web-identity/dist-es/fromTokenFile.js
...
// node_modules/.bun/@aws-sdk+credential-provider-web-identity@3.972.29/node_modules/@aws-sdk/credential-provider-web-identity/dist-es/index.js
