...
function App({
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(FpsMetricsProvider, {
    getFpsMetrics,
    children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV(StatsProvider, {
      store: stats,
      children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV(AppStateProvider, {
        initialState,
        onChangeAppState,
        children
