...
import { denyAskUserQuestionUseChat } from './askUserQuestionPermissionResolve.js'
...
export function createAcpCanUseTool(
  ...
  > => {
    ...
    // ── AskUserQuestion: disabled — AionUI permission round-trip often fails to
    // inject answers back into the model; use plain assistant text instead.
