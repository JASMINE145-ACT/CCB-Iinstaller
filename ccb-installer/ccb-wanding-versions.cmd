...
:: Relaunch through Windows Terminal if available (mirrors ccb-wanding.cmd logic)
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%CCB_INSTALL_DIR%\scripts\ccb-check-update.ps1" -Select
set "CCB_EXIT=%ERRORLEVEL%"
if "%CCB_EXIT%"=="2" (
    echo.
    echo [CCB] Install complete. Close this window and relaunch CCB-Wanding.
)
