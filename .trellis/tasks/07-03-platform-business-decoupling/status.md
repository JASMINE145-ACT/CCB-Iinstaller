...
- `07-03-p4-control-plane-tenant-governance` — completed in `8588abf0`.
...
2. Select and plan the P5 non-trade second vertical pilot.
3. Keep P2–P4 production cutovers opt-in until the human checklist is completed.
