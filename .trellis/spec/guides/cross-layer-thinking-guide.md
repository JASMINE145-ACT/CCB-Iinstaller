...
## This project: 4-layer chain

Before generic steps below, read the project boundary:

```text
AionUI (L1) → aioncore (L2) → route-b / ACP slot (L3) → CCB-Wanding --acp (L4)
```

- Entry: [`../integration/aionui-ccb-boundary.md`](../integration/aionui-ccb-boundary.md)
- Producer events (L4): [`../backend/acp-session-flow.md`](../backend/acp-session-flow.md)
- Consumer UI (L1): [`../frontend/chat-acp-flow.md`](../frontend/chat-acp-flow.md)
- Full spec map: [`../index.md`](../index.md)
