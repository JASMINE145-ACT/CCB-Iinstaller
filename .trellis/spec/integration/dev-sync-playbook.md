...
| `ccb-installer/config/skills/ccb-subagent-gate/**` | ❌ | `deploy-subagent-gate-skill.ps1` + **新会话** | `modes.json` → `quotation-agent:knowledge` = **off**; L1 has **no** PreToolUse pre-match gate |
