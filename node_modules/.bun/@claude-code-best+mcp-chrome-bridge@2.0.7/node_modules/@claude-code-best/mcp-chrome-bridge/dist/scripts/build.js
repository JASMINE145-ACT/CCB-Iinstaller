...
// 复制配置文件
console.log('复制配置文件...');
const mcpDistDir = path_1.default.join(distDir, 'mcp');
try {
    fs_1.default.mkdirSync(mcpDistDir, { recursive: true });
...
3. 注册Native Messaging主机:
   \`\`\`
   # 用户级别安装（推荐）
   ${constant_1.COMMAND_NAME} register

   # 如果用户级别安装失败，可以尝试系统级别安装
   ${constant_1.COMMAND_NAME} register --system
   # 或者使用管理员权限
   sudo ${constant_1.COMMAND_NAME} register
   \`\`\`
