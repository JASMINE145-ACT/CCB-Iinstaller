...
class NativeMessagingHost {
        ...
        try {
            switch (message.type) {
                case chrome_mcp_shared_1.NativeMessageType.START:
                    await this.startServer(((_a = message.payload) === null || _a === void 0 ? void 0 : _a.port) || constant_1.NATIVE_SERVER_PORT);
                    break;
    ...
    async stopServer() {
        ...
        try {
            ...
            this.sendMessage({ type: chrome_mcp_shared_1.NativeMessageType.SERVER_STOPPED });
        }
        catch (error) {
    ...
    sendError(errorMessage) {
        this.sendMessage({
            type: chrome_mcp_shared_1.NativeMessageType.ERROR_FROM_NATIVE_HOST,
