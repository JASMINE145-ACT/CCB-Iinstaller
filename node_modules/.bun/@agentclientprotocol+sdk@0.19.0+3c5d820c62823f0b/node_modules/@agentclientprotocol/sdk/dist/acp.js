...
export class AgentSideConnection {
            ...
            switch (method) {
                ...
                case schema.AGENT_METHODS.document_did_open: {
                    if (!agent.unstable_didOpenDocument)
                        return;
                    const validatedParams = validate.zDidOpenDocumentNotification.parse(params);
                ...
                case schema.AGENT_METHODS.document_did_change: {
                    if (!agent.unstable_didChangeDocument)
                        return;
                    const validatedParams = validate.zDidChangeDocumentNotification.parse(params);
                ...
                case schema.AGENT_METHODS.document_did_close: {
                    if (!agent.unstable_didCloseDocument)
                        return;
                    const validatedParams = validate.zDidCloseDocumentNotification.parse(params);
                ...
                case schema.AGENT_METHODS.document_did_save: {
                    if (!agent.unstable_didSaveDocument)
                        return;
                    const validatedParams = validate.zDidSaveDocumentNotification.parse(params);
                ...
                case schema.AGENT_METHODS.document_did_focus: {
                    if (!agent.unstable_didFocusDocument)
                        return;
                    const validatedParams = validate.zDidFocusDocumentNotification.parse(params);
    ...
    async unstable_createElicitation(params) {
        return await this.#connection.sendRequest(schema.CLIENT_METHODS.elicitation_create, params);
    }
    /**
     * **UNSTABLE**
     *
    ...
    async unstable_completeElicitation(params) {
        return await this.#connection.sendNotification(schema.CLIENT_METHODS.elicitation_complete, params);
    }
    /**
     * Extension method
     *
...
export class ClientSideConnection {
        ...
        const requestHandler = async (method, params) => {
            switch (method) {
                ...
                case schema.CLIENT_METHODS.elicitation_create: {
                    ...
                    const validatedParams = validate.zCreateElicitationRequest.parse(params);
            ...
            switch (method) {
                ...
                case schema.CLIENT_METHODS.elicitation_complete: {
                    if (!client.unstable_completeElicitation)
                        return;
                    const validatedParams = validate.zCompleteElicitationNotification.parse(params);
    ...
    async unstable_logout(params) {
        return ((await this.#connection.sendRequest(schema.AGENT_METHODS.logout, params)) ?? {});
    }
    /**
    ...
    async unstable_startNes(params) {
        return await this.#connection.sendRequest(schema.AGENT_METHODS.nes_start, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_suggestNes(params) {
        return await this.#connection.sendRequest(schema.AGENT_METHODS.nes_suggest, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_closeNes(params) {
        return ((await this.#connection.sendRequest(schema.AGENT_METHODS.nes_close, params)) ?? {});
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_didOpenDocument(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.document_did_open, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_didChangeDocument(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.document_did_change, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_didCloseDocument(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.document_did_close, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_didSaveDocument(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.document_did_save, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_didFocusDocument(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.document_did_focus, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_acceptNes(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.nes_accept, params);
    }
    /**
     * **UNSTABLE**: This capability is not part of the spec yet, and may be removed or changed at any point.
     *
    ...
    async unstable_rejectNes(params) {
        return await this.#connection.sendNotification(schema.AGENT_METHODS.nes_reject, params);
    }
    /**
     * Extension method
     *
